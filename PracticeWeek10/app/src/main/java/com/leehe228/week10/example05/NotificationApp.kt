package com.leehe228.week10.example05
...
import com.leehe228.week10.MainActivity
import com.leehe228.week10.R
    ...
    Column(
        ...
        Button(onClick = {
            showLargeTextNotification(
                context, channelId, notificationId + 2, "My Large Text Notification", bigText
            )
        }, modifier = Modifier.padding(top = 16.dp)) {
...
fun showSimpleNotification(
    ...
    val builder = NotificationCompat.Builder(context, channelId)
        .setSmallIcon(R.drawable.baseline_access_alarm_24).setContentTitle(textTitle)
        .setContentText(textContent).setPriority(priority)
...
fun showSimpleNotificationWithTapAction(
    ...
    val builder = NotificationCompat.Builder(context, channelId)
        .setSmallIcon(R.drawable.baseline_access_alarm_24).setContentTitle(textTitle)
        .setContentText(textContent).setPriority(priority).setContentIntent(pendingIntent)
        .setAutoCancel(true)
...
fun showLargeTextWithBigIconNotification(
    ...
    val builder = NotificationCompat.Builder(context, channelId)
        .setSmallIcon(R.drawable.baseline_access_alarm_24).setContentTitle(textTitle)
        .setContentText(textContent).setLargeIcon(largeIcon).setStyle(
            NotificationCompat.BigTextStyle().bigText(textContent)
        ).setPriority(priority)
...
fun showBigPictureWithThumbnailNotification(
    ...
    val builder = NotificationCompat.Builder(context, channelId)
        .setSmallIcon(R.drawable.baseline_access_alarm_24).setContentTitle(textTitle)
        .setContentText(textContent).setLargeIcon(bigImage).setStyle(
            NotificationCompat.BigPictureStyle().bigPicture(bigImage)
        ).setPriority(priority)
