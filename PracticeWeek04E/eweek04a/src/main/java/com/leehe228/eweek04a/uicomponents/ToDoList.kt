...
@Composable
fun ToDoList(todoList: MutableList<Item>, showOnlyPending: Boolean, modifier: Modifier = Modifier) {
...
@Preview
@Composable
private fun ToDoListPreview1() {
    Column {
        Text("ShowOnlyPending is False")
        ToDoList(ToDoListFactory.makeToDoList(), showOnlyPending = false)
    }
}

@Preview
@Composable
private fun ToDoListPreview2() {
    Column {
        Text("ShowOnlyPending is True")
        ToDoList(ToDoListFactory.makeToDoList(), showOnlyPending = true)
    }
}
